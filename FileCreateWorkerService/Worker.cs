...
namespace FileCreateWorkerService
{
    public class Worker : BackgroundService
    {
        ...
        private DataTable GetTable(string tableName) {
            ...
            //BUNU YAPMAMIZIN SEBEBÝ 'AdventureWorks2019Context' BU CONTEXTÝN SCOPED OLARAK
            //PROGRAM.CS E YAZILMASI RABBÝTMQCLÝENTSERVÝCE ÝSE SÝNGELTON OLARAK YAZILMIÞTIR
