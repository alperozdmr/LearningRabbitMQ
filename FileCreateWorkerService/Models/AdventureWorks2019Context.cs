...
namespace FileCreateWorkerService.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        //Scaffold-DbContext "Data Source=DESKTOP-AMHHP22\MSSQLSERVER01;Initial Catalog=AdventureWorks2019;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -Tables Production.Product
        // yukarıda yazılan commandi package manager console girdiğimde 
        // sonda belirttiğim tablo ismine göre MSSqlden productın içindeki parametreleri çeker
        // ve ona uygun bir db context oluşturur bu örneği model klasöründe görebilirsin.
        /// <summary>
